...
bool RegulatorPID::getTiPozaCalka() const
{
    return tiPozaCalka;
}

void RegulatorPID::resetCzescI()
{
    suma_uchybu = 0.0;
}
...
double RegulatorPID::getWyjP() const
{
    return wyj_p;
}
double RegulatorPID::getWyjI() const
{
    return wyj_i;
}
double RegulatorPID::getWyjD() const
{
    return wyj_d;
}
